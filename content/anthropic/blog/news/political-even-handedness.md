...
URL Source: https://www.anthropic.com/news/political-even-handedness
...
On our own platforms, we want Claude to take an even-handed approach when it comes to politics:<sup>1</sup>
...
We tested our most capable models, Claude Sonnet 4.5 and Claude Opus 4.1. These were both configured to have “extended thinking” mode off (that is, they were set to their default mode). These models included our latest [Claude.ai](http://claude.ai/redirect/website.v1.0) system prompt.
