...
Today, we’re introducing a paid plan for our [Claude.ai](https://claude.ai/redirect/website.v1.0) chat experience, currently available in the US and UK.
...
With [Claude Pro](https://claude.ai/redirect/website.v1.0/settings/billing?action=subscribe), subscribers can now gain **5x more usage** of our latest model, Claude 2, for a monthly price of $20 (US) or £18 (UK).
