...
When provided with only the exact passage Claude used to write the question, Claude Instant was able to answer its own generated question about 90% of the time. We discarded the 10% of questions it answered incorrectly – since Claude was getting them wrong even in a short-context situation, they’re too difficult to be useful for testing long context.[1](https://www.anthropic.com#f1)
...
2. **Nongov examples** - Give Claude two fixed examples of correctly answered general knowledge multiple choice questions that are unrelated to the government document[2](https://www.anthropic.com#f2)
...
For Claude Instant, there seems to be a monotonic inverse relationship between performance and the distance of the relevant passage to the question and the end of the prompt, while Claude 2 performance on 95K sees a small dip in the middle.[3](https://www.anthropic.com#f3)
