...
URL Source: https://alignment.anthropic.com/2025/cheap-monitors
...
We train linear probes on the model activations to be classifiers ([Belinkov, 2021](https://arxiv.org/abs/2102.12452)) using linear regression. For an input sequence 
