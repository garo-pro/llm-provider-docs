...
The Index’s [initial report](http://arxiv.org/abs/2503.04761) provides first-of-its-kind data and analysis based on millions of anonymized conversations on [Claude.ai](http://claude.ai/redirect/website.v1.0), revealing the clearest picture yet of how AI is being incorporated into real-world tasks across the modern economy.
...
This research was made possible by Claude insights and observations, or "[Clio](https://www.anthropic.com/research/clio)", an automated analysis tool that allows us to analyze conversations with Claude while preserving user privacy<sup>1</sup>. We used Clio on a dataset of approximately one million conversations with Claude (specifically, Free and Pro conversations on [Claude.ai](http://claude.ai/redirect/website.v1.0)), and used it to organize the conversations by occupational task.
...
- We also only analyze data from [Claude.ai](http://claude.ai/redirect/website.v1.0) Free and Pro plans, rather than API, Team, or Enterprise users. While Claude.ai data contains some non-work conversations, we used a language model to filter this data to only contain conversations relevant to an occupational task, which helps to mitigate this concern.
