...
Among the thousands of candidates our tool flagged, we've identified and validated several concepts that act like switches for specific model behaviors.<sup>[1](https://www.anthropic.com#footnote-1)</sup> For example, we discovered:
