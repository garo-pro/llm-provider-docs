...
<sup>*</sup><sup>Labs have noted</sup> <sup>evidence of memorization</sup>(opens in a new window) <sup>on this eval</sup>
...
<sup>** MCP Atlas: results from Scale AI after the latest 2026 April update.  *** Tau2-bench telecom: results for 5.5 and 5.4 with original prompts i.e no prompt adjustment. This omits results from other labs that were evaluated with prompt adjustments.</sup>
