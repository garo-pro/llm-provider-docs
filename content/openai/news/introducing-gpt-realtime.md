...
URL Source: https://openai.com/index/introducing-gpt-realtime
...
Check out our [__docs__(opens in a new window)](http://platform.openai.com/docs/guides/realtime-inputs-outputs) to get started with image input.
