...
In this notebook we will classify the sentiment of reviews using embeddings and zero labeled data! The dataset is created in the [Get_embeddings_from_dataset Notebook](https://developers.openai.com/cookbook/examples/Get_embeddings_from_dataset.ipynb).
...
![](https://developers.openai.com/cookbook/assets/notebook-outputs/examples/zero-shot_classification_with_embeddings/cell-3-output-1.png)
...
![](https://developers.openai.com/cookbook/assets/notebook-outputs/examples/zero-shot_classification_with_embeddings/cell-5-output-1.png)
...
![](https://developers.openai.com/cookbook/assets/notebook-outputs/examples/zero-shot_classification_with_embeddings/cell-7-output-1.png)
