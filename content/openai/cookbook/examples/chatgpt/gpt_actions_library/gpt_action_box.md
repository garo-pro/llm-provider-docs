...
Follow this [Azure Cookbook Guide](https://developers.openai.com/cookbook/examples/azure/functions) for further details deploying an Azure function. Below you will find sample code to add to the function. 
...
Make sure to follow the rest of the Azure guide for post authentication steps and ChatGPT configuration : [Azure Cookbook Guide](https://developers.openai.com/cookbook/examples/azure/functions)
