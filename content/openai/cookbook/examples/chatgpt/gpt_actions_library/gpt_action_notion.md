...
Once you've created a Custom GPT, copy the text below in the Instructions panel. Have questions? Check out [Getting Started Example](https://developers.openai.com/cookbook/examples/chatgpt/gpt_actions_library/.gpt_action_getting_started) to see how this step works in more detail.
