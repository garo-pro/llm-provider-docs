...
4. More on MCP: We have a more detailed [guide](https://developers.openai.com/cookbook/examples/mcp/mcp_tool_guide) on best practices for using MCP tools, but for completeness, we will reiterate a few high-level guidelines here (these are not specific to o3/o4-mini, but are still relevant).
