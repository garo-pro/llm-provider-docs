...
We're using the dataset created using the [previous notebook](https://developers.openai.com/cookbook/examples/fine-tuned_qa/olympics-1-collect-data.ipynb)
...
We save the file for use in the [next notebook](https://developers.openai.com/cookbook/examples/fine-tuned_qa/olympics-3-train-qa.ipynb)
...
![](https://developers.openai.com/cookbook/assets/notebook-outputs/examples/fine-tuned_qa/olympics-2-create-qa/cell-31-output-0.png)
...
![](https://developers.openai.com/cookbook/assets/notebook-outputs/examples/fine-tuned_qa/olympics-2-create-qa/cell-32-output-0.png)
