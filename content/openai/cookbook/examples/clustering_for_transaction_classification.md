...
We'll reuse the approach from the [Clustering Notebook](https://developers.openai.com/cookbook/examples/Clustering.ipynb), using K-Means to cluster our dataset using the feature embeddings we created previously. We'll then use the Completions endpoint to generate cluster descriptions for us and judge their effectiveness
...
![](https://developers.openai.com/cookbook/assets/notebook-outputs/examples/clustering_for_transaction_classification/cell-8-output-1.png)
