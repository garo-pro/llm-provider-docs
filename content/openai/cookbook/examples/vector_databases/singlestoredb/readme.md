...
| Name | Description |
| --- | --- |
| [OpenAI wikipedia semantic search](https://developers.openai.com/cookbook/examples/vector_databases/singlestoredb/OpenAI_wikipedia_semantic_search.ipynb) | Improve ChatGPT accuracy through SingleStoreDB semantic Search in QA |
