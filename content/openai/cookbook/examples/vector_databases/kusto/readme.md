...
![Kusto_Vector](https://developers.openai.com/cookbook/assets/examples/vector_databases/kusto/images/kusto_vector_db.png)
...
![Wiki_embeddings](https://developers.openai.com/cookbook/assets/examples/vector_databases/kusto/images/wiki_embeddings.png)

![semantic_search_flow](https://developers.openai.com/cookbook/assets/examples/vector_databases/kusto/images/semantic_search_user_flow.png)

If you’d like to try this demo, please follow the instructions in the [Notebook](https://developers.openai.com/cookbook/examples/vector_databases/kusto/Getting_started_with_kusto_and_openai_embeddings.ipynb).
