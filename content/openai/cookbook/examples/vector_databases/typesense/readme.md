...
- To learn more about how to use Typesense with OpenAI embeddings, see the notebook here for an example: [examples/vector_databases/Using_vector_databases_for_embeddings_search.ipynb](https://developers.openai.com/examples/vector_databases/Using_vector_databases_for_embeddings_search.ipynb)
