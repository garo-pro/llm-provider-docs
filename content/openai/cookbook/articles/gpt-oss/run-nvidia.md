...
Note: Your input prompts should use the [harmony response](https://developers.openai.com/cookbook/articles/openai-harmony) format for the model to work properly, though this guide does not require it.
